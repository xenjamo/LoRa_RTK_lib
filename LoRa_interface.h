/* copied/ported from Radiohead library
*
* Registers to configure and access LoRa Module (HopeRF, RFM95W)
*
*
*/
...
class RFM95
{
    ...
    bool setModeContRX();
    bool setModeIdle();
    // some basic public functions
    uint8_t write(uint8_t addr, uint8_t data);
    uint8_t read(uint8_t addr);
    uint8_t burstwrite(uint8_t addr, uint8_t* data, uint8_t length);
